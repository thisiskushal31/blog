# Cloud-Managed PostgreSQL Deep Dive - RDS, Cloud SQL, Azure Database
...
*This is Blog 2 of the PostgreSQL Deployment Guide. Return to the [series hub](https://thisiskushal31.github.io/blog/#/blog/postgresql-deployment-guide) to explore all posts.*
