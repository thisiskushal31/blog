...
import content from '../markdown/aerospike_2_architecture.md?raw';

export const blogPost: BlogPost = {
  slug: "aerospike-architecture-deep-dive-hybrid-memory",
  title: "Blog 2: Aerospike Architecture Deep Dive - Hybrid Memory Architecture",
  ...
  coverImage: "/blog/blogImages/aerospike-architecture.png",
};
