...
import content from '../markdown/postgresql_3_self_managed.md?raw';

export const blogPost: BlogPost = {
  slug: "postgresql-self-managed-vm-bare-metal-production-guide",
  title: "Blog 3: Self-Managed PostgreSQL - VM and Bare Metal Production Guide",
  ...
  coverImage: "/blog/blogImages/postgresql-self-managed.png",
};
