...
import content from '../markdown/postgresql_8_decision_matrix.md?raw';

export const blogPost: BlogPost = {
  slug: "postgresql-deployment-decision-matrix-complete-comparison-guide",
  title: "Blog 8: PostgreSQL Deployment Decision Matrix - Complete Comparison Guide",
  ...
  coverImage: "/blog/blogImages/postgresql-decision-matrix.png",
};
