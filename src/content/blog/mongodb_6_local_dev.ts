...
import content from '../markdown/mongodb_6_local_dev.md?raw';

export const blogPost: BlogPost = {
  slug: "mongodb-local-development-docker-native-quick-start",
  title: "Blog 6: MongoDB Local Development - Docker vs Native Quick Start",
  ...
  coverImage: "/blog/blogImages/mongodb-dev.png",
};
