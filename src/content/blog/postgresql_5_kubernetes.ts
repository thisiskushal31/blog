...
import content from '../markdown/postgresql_5_kubernetes.md?raw';

export const blogPost: BlogPost = {
  slug: "postgresql-kubernetes-statefulset-operator-deep-dive",
  title: "Blog 5: Kubernetes PostgreSQL - StatefulSet vs Operator Deep Dive",
  ...
  coverImage: "/blog/blogImages/postgresql-kubernetes.png",
};
