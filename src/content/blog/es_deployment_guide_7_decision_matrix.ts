...
import content from '../markdown/es_deployment_guide_7_decision_matrix.md?raw';

export const blogPost: BlogPost = {
  slug: "elasticsearch-deployment-decision-matrix-complete-comparison-guide",
  title: "Elasticsearch Deployment Decision Matrix - Complete Comparison Guide",
  subtitle: "Comprehensive decision framework for choosing the right Elasticsearch deployment strategy",
