...
import content from '../markdown/mysql_4_docker.md?raw';

export const blogPost: BlogPost = {
  slug: "mysql-docker-container-deployment-strategies",
  title: "Blog 4: Containerized MySQL - Docker Production Strategies",
  ...
  coverImage: "/blog/blogImages/mysql-docker.png",
};
