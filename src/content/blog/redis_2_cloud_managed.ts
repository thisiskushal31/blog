...
import content from '../markdown/redis_2_cloud_managed.md?raw';

export const blogPost: BlogPost = {
  slug: "redis-cloud-managed-elasticache-memorystore-deep-dive",
  title: "Blog 2: Cloud-Managed Redis Deep Dive - ElastiCache, Memorystore, Azure Cache",
  ...
  coverImage: "/blog/blogImages/redis-cloud.png",
};
